...
import com.yadiqian.mymemory.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    private fun shouldEnableSaveButton(): Boolean {
        if (chosenImageUris.size == numImagesRequired && etGameName.text.isNotBlank()
            && etGameName.text.length >= MIN_GAME_NAME_LENGTH) {
            return true
        }
        return false
    }
            ...
            .addOnCompleteListener { gameCreationTask ->
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK") { _, _ ->
                        ...
                        resultData.putExtra(EXTRA_GAME_INTENT, gameName)
